    ...
    draw: function(){
        ...
        if(STATE == 'choose_hero'){
           ...
           if(menus[STATE].position == 0){
            ...
            if(menus[STATE].position == 1){
                this.fontColor.draw('DJ CHULHU', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('DJ CHULHU', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }
