    ...
    draw: function(){
        ...
        if(STATE == 'menu'){
            ...
            if(menus[STATE].position == 0){
                this.fontColor.draw('ENTER SANDBOX', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('ENTER SANDBOX', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 1){
                this.fontColor.draw('CREDITS', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('CREDITS', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }
        }
        ...
        if(STATE == 'choose_hero'){
           ...
           if(menus[STATE].position == 0){
                this.fontColor.draw('STRONG MAN', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('STRONG MAN', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 1){
                this.fontColor.draw('DJ CHULHU', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('DJ CHULHU', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }
        ...
        if(STATE == 'game_menu'){
            ...
            if(menus[STATE].position == 0){
                this.fontColor.draw('RETURN TO GAME', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('RETURN TO GAME', this.menu.x, menus[STATE].cursor[0], ig.Font.ALIGN.CENTER );
            }
            
            if(menus[STATE].position == 1){
                this.fontColor.draw('LOAD LEVEL', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('LOAD LEVEL', this.menu.x, menus[STATE].cursor[1], ig.Font.ALIGN.CENTER );
            }
