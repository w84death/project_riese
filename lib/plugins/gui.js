...
ig.GUI = ig.Class.extend({
    ...
    init: function(){
        ...
        if( ig.ua.mobile ) {
            ...
            this.buttons = [
                ...
                new ig.TouchButton( 'b', pad.x2-32, pad.y-60, 16, 16, this.buttonImage, 7 ),
                new ig.TouchButton( 'y', pad.x2, pad.y-60, 16, 16, this.buttonImage, 5 ),//menu
                new ig.TouchButton( 'a', pad.x2, pad.y, 16, 16, this.buttonImage, 4 ),//jump
                new ig.TouchButton( 'x', pad.x2, pad.y+24, 16, 16, this.buttonImage, 6 )//shoot
            ];
        }
    ...
    draw: function(){
        ...
        if(STATE == 'pause'){
            this.fontWhite.draw('PAUSED', this.center.x, this.center.y, ig.Font.ALIGN.CENTER );
        }
